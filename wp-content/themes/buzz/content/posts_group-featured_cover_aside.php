<?php
/**
 * Posts Group: Featured Post // Cover Posts Aside
 */
...
if ( $_current_widget_instance['is_first_item'] ) : ?>
	<div <?php post_class( 'post-group grid-item cover-item grid-one featured-post col-sm-8' ); ?>>
		<?php if ( 'show' === $_current_widget_instance['featured_thumbnail'] && $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '800', 'height' => '515', 'crop' => true, 'placeholder' => true ) ) ) : ?>
...
<?php else : ?>
	<div <?php post_class( 'post-group grid-item cover-item grid-three col-sm-4' ); ?>>
