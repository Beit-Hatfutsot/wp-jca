...
?>
<div <?php post_class( 'recent-post grid-item grid-one' ); ?>>
	<div class="item-inner">
		<?php if ( 'show' === $_current_widget_instance['thumbnail'] && $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '1140', 'height' => '610', 'crop' => true, 'placeholder' => true ) ) ) : ?>
		...
		<div class="caption">
			...
			<div class="entry-meta">
				...
				<?php if ( 'show' === $_current_widget_instance['metadata_author'] ) : ?>
					<span class="entry-user"><?php the_author_link(); ?></span>
				<?php endif; ?>
			</div>
